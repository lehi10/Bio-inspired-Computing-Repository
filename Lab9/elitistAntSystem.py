	...
	for r_0 in range( n_cities ):
		for r_1 in range( n_cities ):
			if( r_0 != r_1):
				...
				best = check_best_global( path_list[global_index], \
				...
				pheromone_matrix[r_0][r_1] = (1-p)*	pheromone_matrix[r_0][r_1]  + tmp + best
...
def eas_algorithm():
	...
	for i in range( n_iterations ):
		path_list = send_ants()
		costs_lists = print_ant_results( path_list )
		update_pheromone_elitist( path_list, costs_lists)
